  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <View style={Styles.header}>
        ...
        />
        <Text style={{fontWeight: '500'}}>Add New Voter</Text>
        <Text
          onPress={() => {
            navigation.goBack();
          }}
      ...
      <ScrollView>
        ...
        <View style={Styles.middleCont}>
          ...
          <Text style={Styles.title}>Preferred Number</Text>
          <View
            style={[
              Styles.inputCont,
              {
          ...
          <Text style={Styles.title}>Cell Phone Number</Text>
          <View
            style={[
              Styles.inputCont,
              {
